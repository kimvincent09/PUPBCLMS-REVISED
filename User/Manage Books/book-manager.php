...
<a href = 'search-student.php'><img src = '$Homebutton' class = 'Homebutton'></a>
    ...
    <table class = "set">
        ...
        <tr>
            <td class="right">  
            <img src = "$Managebooksbuttonhover" style = "width:400px" class = 'idle'>
            <img src = "$Managebooksbutton" style = "width:400px" class = 'hover student'>  

</td>
<td class="left" rowspan = '2'>
<center> <iframe class = 'studtbl table hidden' src ='search-books.php'></iframe></center>
<center> <iframe class = 'bktbl table hidden' src ='search-repository.php'></iframe></center>
        ...
        <tr>
            ...
            <img src = "$Managerepositorybuttonhover" style = "width:400px" class = 'idle1'>
            <img src = "$Managerepositorybutton" style = "width:400px" class = 'hover1 book'>
